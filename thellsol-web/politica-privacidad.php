...
$privacySections = [
    [
        ...
        'paragraphs' => ['privacy.section1.body']
    ],
    [
        'title' => 'privacy.section2.title',
        'paragraphs' => ['privacy.section2.body1', 'privacy.section2.body2']
    ],
    [
        'title' => 'privacy.section3.title',
        'paragraphs' => ['privacy.section3.intro'],
        'list' => [
            ...
            'privacy.section3.item6'
        ]
    ],
    [
        'title' => 'privacy.section4.title',
        'paragraphs' => ['privacy.section4.body']
    ]
];
?>
<!DOCTYPE html>
...
<head>
    ...
    <title><?php echo t('privacy.metaTitle'); ?></title>
...
<body>
    ...
    <div class="legal-content">
        <h1><?php echo t('privacy.title'); ?></h1>
