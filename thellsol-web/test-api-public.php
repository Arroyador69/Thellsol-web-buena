...
<head>
    ...
    <title>Test API Pública - ThellSol</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1>Test API Pública - ThellSol</h1>
        <p>Esta página prueba la conexión directa con las propiedades del dashboard:</p>
        
        <div id="status" class="status loading">
            🔄 Cargando propiedades desde el dashboard...
        </div>
    ...
    async function loadPropertiesFromAPI() {
        try {
            const response = await fetch('api-properties-public.php');
            ...
            if (data.success) {
                ...
                statusDiv.innerHTML = `✅ Conexión exitosa - ${data.count} propiedades encontradas`;
